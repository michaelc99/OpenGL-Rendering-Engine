...
TEST_MAIN_SRC_FILES := math_tests/math_test.cpp
TEST_EXECUTABLE_FILES := math_test
...
FILES_TO_REMOVE := $(subst /,\,$(EXCECUTABLE_FILES_TO_REMOVE) $(TEST_EXCECUTABLE_FILES_TO_REMOVE) $(OBJ_FILES_TO_REMOVE) $(TEST_OBJ_FILES_TO_REMOVE))
.PHONY : clean
clean :
