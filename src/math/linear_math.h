...
// Theta is the counter clockwise angle (in radians) to rotate vecToRotate by.
template<typename T>
Vec3<T> rotate(const Vec3<T>& vecToRotate, const Vec3<T>& rotationCenterVec, const Vec3<T>& rotationAxisUnitVec, const T theta) {
